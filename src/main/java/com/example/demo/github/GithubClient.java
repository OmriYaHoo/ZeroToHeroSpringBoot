...
import com.example.demo.utils.GithubProperties;
...
public class GithubClient {
    ...
    private static final String EVENT_ISSUES_URL = "https://api.github.com/repos/{orgName}/{repoName}/issues/events";

    private final RestTemplate restTemplate;

    public GithubClient(RestTemplateBuilder builder, GithubProperties properties, MeterRegistry meterRegistry) {
        this.restTemplate = builder
                // This way of adding interceptors data with the builder prevent from our token info
                // to be leaked to other parts or APIs of the program which is crucial from security POV
    ...
    // This class is for checking how much API calls you have left to do with GitHub
    private static class MetricsInterceptor implements ClientHttpRequestInterceptor {
        ...
        public MetricsInterceptor(MeterRegistry meterRegistry) {
            // without api key the default number of API calls you can make is 60 per hour
